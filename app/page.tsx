      ...
      <section className="section section-gray">
        <div className="container">
          ...
          <div className="grid-split reveal">
            <div>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="http://maroon-partridge-424184.hostingersite.com/wp-content/uploads/2026/07/Front-4.webp" alt="Battery comparison" style={{ borderRadius: 'var(--radius-md)', boxShadow: 'var(--shadow-lg)', width: '100%' }} />
            </div>
