  ...
  return (
    <>
      ...
      <section className="hero">
        <div className="hero-bg" style={{ backgroundImage: "url('https://github.com/Michael112315/AESON-POWER-PH/blob/4e82aa4f706ea4959182759c83e48f4b5831749c/app/Front%2030months.webp')" }}></div>
